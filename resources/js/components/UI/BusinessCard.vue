<template>
    <div class="card m-3 shadow bg-light" style="width: 20rem;">
        <img :src="coverPhoto" style="height: 18rem;" class="card-img-top mt-2 img-fluid" alt="...">
        <div class="card-body px-0">
            ...
            <span class="border px-2 rounded-pill d-block">
...
<script>
    ...
    // export default {
    //     props: ['firstName', 'lastName', 'phoneNumber', 'addressLine1', 'addressLine2', 'addressLine3', 'businessName'],
    //     computed: {
    //         fullName() {
...
<script setup>
    import { computed } from 'vue';
    const props = defineProps(['userId', 'firstName', 'lastName', 'phoneNumber', 'addressLine1', 'addressLine2', 'addressLine3', 'businessName', 'coverPhoto']);
