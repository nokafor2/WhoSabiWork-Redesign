...
<script>
    import TimeCheckBox from './TimeCheckBox.vue';
    ...
    export default {
        ...
        data() {
            return {
                ...
                tenThirtyAM: '10:30',
                elevenAM: '11:00',
                elevenThirtyAM: '11:30',
                twelvePM: '12:00',
                twelveThirtyPM: '12:30',
                onePM: '01:00',
                oneThirtyPM: '01:30',
                twoPM: '2:00',
                twoThirtyPM: '2:30',
        ...
        methods: {
            updateSelectedTime(timeSelected, timeName) {
                if (timeSelected) {
                    this.selectedTime.push(timeName);
                } else {
